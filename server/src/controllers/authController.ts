...
/**
     * Register a new reader account (public).
     * @returns 201 with { token: string } or 409 if email in use, 400 if missing fields
     * @param req.body.name User name
     * @param req.body.email User email
     * @param req.body.password User password
 */
export const registerReader = async (req: Request, res: Response, next: NextFunction) => {
