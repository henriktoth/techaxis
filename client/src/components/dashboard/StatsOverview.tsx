...
const StatsOverview = ({ totalArticles, publishedCount, draftCount, reviewCount }: StatsOverviewProps) => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 border-l-4 border-l-green-200">
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 border-l-4 border-l-blue-200">
        <h3 className="text-gray-500 text-sm font-medium uppercase tracking-wider">In Review</h3>
        <p className="text-3xl font-bold text-gray-900 mt-2">{reviewCount}</p>
      </div>
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 border-l-4 border-l-yellow-200">
